...
class TownForgeHousePageParser {

    static async parse(html: string): Promise<TownForgeHousePage> {
        const page = new TownForgeHousePage(new Role());
...
export = TownForgeHousePageParser;