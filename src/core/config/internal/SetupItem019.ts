...
class SetupItem019 implements SetupItem {

    readonly #code: string = "019";
    readonly #name: string = "自定义的套装Ａ";
    ...
    #doRender(id: string) {
        ...
        html += "<input type='button' class='dynamic_button' id='_019_button' value='设置'>";
        html += "</td>";
