...
class SetupItem021 implements SetupItem {

    readonly #code: string = "021";
    readonly #name: string = "自定义的套装Ｃ";
    ...
    #doRender(id: string) {
        ...
        html += "<input type='button' class='dynamic_button' id='_021_button' value='设置'>";
        html += "</td>";
