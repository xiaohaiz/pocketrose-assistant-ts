...
class SetupItem022 implements SetupItem {
    ...
    readonly #code: string = "022";
    readonly #name: string = "自定义的套装Ｄ";
    ...
    #doRender(id: string) {
        ...
        html += "<input type='button' class='dynamic_button' id='_022_button' value='设置'>";
        html += "</td>";
