...
const code: string = "058";
const name: string = "胜利者站在左边";
...
function doRender() {
    ...
    html += "<td style='background-color:#E8E8D0;text-align:left'>战斗布局专属设置，战斗结果报告中胜利者站在左边。</td>";
    html += "</tr>";

    $("#setup_item_table").append($(html));

    const value = SetupLoader.isWinnerLeftEnabled();
