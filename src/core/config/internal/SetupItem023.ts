...
class SetupItem023 implements SetupItem {
    ...
    readonly #code: string = "023";
    readonly #name: string = "自定义的套装Ｅ";
    ...
    #doRender(id: string) {
        ...
        html += "<input type='button' class='dynamic_button' id='_023_button' value='设置'>";
        html += "</td>";
