...
class PetManager extends CommonWidget {
    ...
    private _createCagePetPanelHTML(): string {
        ...
        html += "<tr style='background-color:skyblue'>";
        html += "<th style='font-size:120%' colspan='13'>＜ 黄 金 笼 子 ＞</th>"
        html += "</tr>";
        html += "<tr style='background-color:wheat'>";
        html += "<th>序号</th>";
        html += "<th>名字</th>";
    ...
    private _createRanchPetPanelHTML(): string {
        ...
        html += "<tr style='background-color:skyblue'>";
        html += "<th style='font-size:120%' colspan='12'>＜ 城 堡 牧 场 ＞</th>"
        html += "</tr>";
        html += "<tr style='background-color:wheat'>";
        html += "<th>序号</th>";
        html += "<th>名字</th>";
    ...
    private async _bindSendButton() {
        $(".C_pocket_petManager_sendButton").on("click", event => {
            ...
            if (target === undefined) {
                MessageBoard.publishWarning("没有选择发送宠物的对象，忽略！");
                return;
            }
    ...
    private async _renderCage() {
        ...
        html += "<td style='text-align:right' colspan='13'>";
    ...
    private async _renderRanch() {
        ...
        html += "<button role='button' class='C_pocket_petManager_ranchPetButton' " +
            "id='_pocket_petManager_internalCloseRanch'>关闭城堡仓库</button>";
        html += "</td>";
        html += "</tr>";
        ranchPetTable.append($(html));
