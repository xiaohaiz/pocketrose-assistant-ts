...
function doGenerateSetupItem() {
    let selection = "";
    selection += "<select id='select_" + code + "'>";
    selection += "<option class='option_class_" + code + "' value='1'>启用</option>";
    selection += "<option class='option_class_" + code + "' value='0'>禁用</option>";
    selection += "</select>";
    return selection;
}
