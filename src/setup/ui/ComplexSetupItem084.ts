...
class ComplexSetupItem084 extends AbstractSetupItem {

    private readonly name: string = "城堡的快捷按钮";
    ...
    protected doRender(): void {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            _.forEach(CastleDashboardShortcutManager.getAvailableShortcutMappingIds(), it => {
        ...
        const config = CastleDashboardShortcutManager.loadCastleDashboardShortcutConfig();
